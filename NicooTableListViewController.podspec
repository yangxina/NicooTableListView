...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/504672006@qq.com/NicooTableListViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '504672006@qq.com' => 'yangxin@tzpt.com' }
  s.source           = { :git => 'https://github.com/504672006@qq.com/NicooTableListViewController.git', :tag => s.version.to_s }
